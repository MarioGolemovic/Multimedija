...
function zoomLeo(){
  document.getElementById('leo').style.width="640px";
  document.getElementById('leo').style.height="480px";
}

function zoomMario(){
  document.getElementById('mario').style.width="640px";
  document.getElementById('mario').style.height="600px";
}
